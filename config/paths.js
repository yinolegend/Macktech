...
const FRONTEND_ICONS_DIR = path.join(FRONTEND_DIR, 'icons');
...
const HANDBOOK_DIR = path.join(DATA_DIR, 'handbook');
const ANNOUNCEMENT_FILES_DIR = path.join(DATA_DIR, 'announcements_files');
const MAP_ASSETS_DIR = path.join(DATA_DIR, 'map_assets');
const CALIBRATION_ATTACHMENTS_DIR = path.join(DATA_DIR, 'calibration_attachments');
